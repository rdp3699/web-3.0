...
export const HeroOrbit = ({ children, size, rotation,spinDuration='40s',shouldOrbit = true,shouldSpin=true}: PropsWithChildren<{ size: number; rotation: number; spinDuration?:string;shouldOrbit?:boolean,shouldSpin?:boolean}>) => {
    return (
